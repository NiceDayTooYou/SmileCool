	...
	[
		{
			...
			icon: 'feather:gift',
			text: '赞助',
			href: 'https://nice.199681.xyz',
		},
                {
			type: NavigationItemType.LINK,
			icon: 'feather:headphones',
			text: '歌单',
			href: 'https://music.199681.xyz',
		},
                {
			type: NavigationItemType.LINK,
			icon: 'feather:circle',
			text: '检测',
			href: 'https://time.199681.xyz',
		},
                {
			type: NavigationItemType.LINK,
			icon: 'feather:at-sign',
			text: 'About',
			href: 'https://series.199681.xyz',
		},
                {
			type: NavigationItemType.LINK,
			icon: 'feather:tv',
			text: 'Print',
			href: 'https://print.199681.xyz',
		},
                {
			type: NavigationItemType.LINK,
			icon: 'feather:smile',
			text: 'One',
			href: 'https://mean.199681.xyz',
		},
                {
			type: NavigationItemType.LINK,
			icon: 'feather:check-circle',
			text: 'Code',
			href: 'https://code.199681.xyz',
		},
		{
			type: NavigationItemType.LINK,
			icon: 'feather:clock',
	...
	[
		{
			...
			text: 'TwitterX',
			href: 'https://x.com/NiceDayTooYou',
			external: true,
		},
		{
			type: NavigationItemType.LINK,
			icon: 'feather:star',
			text: 'instagram',
			href: 'https://www.instagram.com/serendipityniceday',
			external: true,
		},
	],
];
